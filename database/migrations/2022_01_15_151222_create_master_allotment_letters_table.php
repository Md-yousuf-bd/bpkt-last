...
class CreateMasterAllotmentLettersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_allotment_letters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('master_allotment_letters');
    }
}
