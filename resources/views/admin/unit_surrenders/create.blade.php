            ...
            <div class="col-lg-10 col-md-10 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('commons/content_header.Add Unit Surrender')</h5>
                        <div class="card-tools">

                        </div>
                    </div>
                    <form id="addUnitSurrenderForm" action="{{route('unit-surrender.store')}}" method="post" class="">
                        <div class="card-body">
                            {{ csrf_field() }}
                            @php
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" name="surrender_memo" id="surrender_memo" class="form-control" placeholder="সমর্পনের স্মারক লিখুন"  value="@if($old_data!=null){{$old_data['surrender_memo']}}@endif">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label">সমর্পনের স্মারকের তারিখ</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="surrender_memo_date" name="surrender_memo_date" readonly="readonly" placeholder="সমর্পনের স্মারকের তারিখ লিখুন"  value="@if($old_data!=null){{$old_data['surrender_memo_date']}}@endif">
                                        <div class="input-group-append">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <button type="reset" class="btn btn-sm btn-default" onclick="resetForm('addUnitSurrenderForm','ইউনিটের সমর্পন যুক্ত করণ ফরম','আপনি কি সত্যি ফরমটি রিসেট করতে চান?');return false;">@lang('commons/buttons.Reset')</button>
                                </div>
                            </div>
                        </div>
                    </form>
