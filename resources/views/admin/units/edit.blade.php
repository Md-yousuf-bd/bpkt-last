            ...
            <div class="col-lg-10 col-md-10 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('commons/content_header.Edit Unit')</h5>
                        <div class="card-tools">

                        </div>
                    </div>
                    <form id="editUnitForm" action="{{route('unit.update',[$unit->id])}}" method="post" class="">
                        <div class="card-body">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="ইংরেজিতে নাম লিখুন"  value="{{$unit->name ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> নাম (বাংলা) <span class="text-danger">*</span></label>
                                    <input type="text" name="name_bangla" id="name_bangla" class="form-control" placeholder="বাংলায় নাম লিখুন"  value="{{$unit->name_bangla ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control select2" name="parent_unit_id" id="parent_unit_id">
                                        @foreach($range_metros as $opt)
                                            <option value="{{$opt->id}}" @if($unit->parent_unit_id==$opt->id) selected @endif >{{$opt->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> প্রাতিষ্ঠানিক কোড</label>
                                    <input type="text" name="institution_code" id="institution_code" class="form-control" placeholder="প্রাতিষ্ঠানিক কোড লিখুন"  value="{{$unit->institution_code ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> অফিস আইডি</label>
                                    <input type="text" name="office_id" id="office_id" class="form-control" placeholder="অফিস আইডি লিখুন"  value="{{$unit->office_id ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> ডিডিও আইডি</label>
                                    <input type="text" name="ddo_id" id="ddo_id" class="form-control" placeholder="ডিডিও আইডি লিখুন"  value="{{$unit->ddo_id ?? ''}}">
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="form-group col-md-6 col-sm-12">--}}
{{--                                    <input type="hidden" id="unit_head_id_selected_text" name="unit_head_id_selected_text" value="{{$unit->unit_head->letter_name ?? ''}}">--}}
{{--                                    <input type="hidden" id="unit_head_id_selected_value" name="unit_head_id_selected_value" value="{{$unit->unit_head_id ?? ''}}">--}}
...
{{--                                        @if($unit->unit_head_id>0)--}}
{{--                                            <option value="{{$unit->unit_head_id}}" selected >{{$unit->unit_head->letter_name ?? ''}}</option>--}}
{{--                                        @endif--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                                <div class="form-group col-md-6 col-sm-12">--}}
{{--                                    <input type="hidden" id="for_attention_id_selected_text" name="for_attention_id_selected_text" value="@if($unit->for_attention_id>0) {{$unit->for_attention->letter_name ?? ''}} @endif">--}}
{{--                                    <input type="hidden" id="for_attention_id_selected_value" name="for_attention_id_selected_value" value=" {{$unit->for_attention_id ?? ''}}">--}}
...
{{--                                        @if($unit->for_attention_id>0)--}}
{{--                                            <option value="{{$unit->for_attention_id}}" selected >{{$unit->for_attention->letter_name ?? ''}}</option>--}}
{{--                                        @endif--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" name="unit_head_name" id="unit_head_name" class="form-control" placeholder="ইউনিট প্রধানের ইংরেজিতে নাম লিখুন"  value="{{$unit->unit_head_name ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label">  ইউনিট প্রধানের নাম (পত্রে ব্যবহারের জন্য) <span class="text-danger">*</span></label>
                                    <input type="text" name="unit_head_letter_name" id="unit_head_letter_name" class="form-control" placeholder="ইউনিট প্রধানের পত্রে ব্যবহারযোগ্য নাম লিখুন"  value="{{$unit->unit_head_letter_name ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> ইউনিট প্রধানের ইমেইল</label>
                                    <input type="text" name="unit_head_email" id="unit_head_email" class="form-control" placeholder="ইউনিট প্রধানের ইমেইল লিখুন"  value="{{$unit->unit_head_email ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> ইউনিট প্রধানের মোবাইল নং</label>
                                    <input type="text" name="unit_head_mobile" id="unit_head_mobile" class="form-control" placeholder="ইউনিট প্রধানের মোবাইল নং লিখুন"  value="{{$unit->unit_head_mobile ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control select2" name="unit_head_designation_id" id="unit_head_designation_id">
                                        @foreach($designations as $opt)
                                            <option value="{{$opt->id}}" @if($unit->unit_head_designation_id==$opt->id) selected @endif >{{$opt->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> দৃঃ আঃ এর জন্য অফিসারের নাম (ইংরেজিতে)</label>
                                    <input type="text" name="for_attention_name" id="for_attention_name" class="form-control" placeholder="দৃঃ আঃ এর জন্য অফিসারের ইংরেজিতে নাম লিখুন"  value="{{$unit->for_attention_name ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label">  দৃঃ আঃ এর জন্য অফিসারের নাম (পত্রে ব্যবহারের জন্য)</label>
                                    <input type="text" name="for_attention_letter_name" id="for_attention_letter_name" class="form-control" placeholder="দৃঃ আঃ এর জন্য অফিসারের পত্রে ব্যবহারযোগ্য নাম লিখুন"  value="{{$unit->for_attention_letter_name ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> দৃঃ আঃ এর জন্য অফিসারের ইমেইল</label>
                                    <input type="text" name="for_attention_email" id="for_attention_email" class="form-control" placeholder="দৃঃ আঃ এর জন্য অফিসারের ইমেইল লিখুন"  value="{{$unit->for_attention_email ?? ''}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label"> দৃঃ আঃ এর জন্য অফিসারের মোবাইল নং</label>
                                    <input type="text" name="for_attention_mobile" id="for_attention_mobile" class="form-control" placeholder="দৃঃ আঃ এর জন্য অফিসারের মোবাইল নং লিখুন"  value="{{$unit->for_attention_mobile ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control select2" name="for_attention_designation_id" id="for_attention_designation_id">
                                        ...
                                        @foreach($designations as $opt)
                                            <option value="{{$opt->id}}" @if($unit->for_attention_designation_id==$opt->id) selected @endif >{{$opt->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="number" name="priority" id="priority" class="form-control" placeholder="কোডের অগ্রাধিকার লিখুন" value="{{$unit->priority ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-control-label">অবস্থা</label>
                                    <select class="form-control select2" name="status" id="status">
                                        <option value="1" @if($unit->status==1) selected @endif >সক্রিয়</option>
                                        <option value="0" @if($unit->status==0) selected @endif >নিষ্ক্রিয়</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <button type="reset" class="btn btn-sm btn-default" onclick="resetForm('editUnitForm','প্রাপকের তথ্য যুক্ত করণ ফরম','আপনি কি সত্যি ফরমটি রিসেট করতে চান?');return false;">@lang('commons/buttons.Reset')</button>
                                </div>
                            </div>
                        </div>
                    </form>
