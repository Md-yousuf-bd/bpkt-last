            ...
            <div class="col-lg-10 col-md-10 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('commons/content_header.Edit Surrender Letter')</h5>
                        <div class="card-tools">
                            <a class="btn btn-default btn-sm" href="{{route('code-surrender-letter.show',[$surrender_letter->id])}}" ><span class="fa fa-eye"></span> চিঠি দেখুন</a>
                        </div>
                    </div>
                    <form id="editUnitSurrenderLetterForm" action="{{route('code-surrender-letter.update',[$surrender_letter->id])}}" method="post" class="" enctype="multipart/form-data">
                        <div class="card-body">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <textarea name="header_middle_heading" id="header_middle_heading" style="width: 100%;">{{$surrender_letter->header_middle_heading ?? ''}}</textarea>
                                </div>
                            </div>
                                    ...
                                    <label class="form-control-label up-image">
                                        <div class="container">
                                            ...
                                            @if(isset($surrender_letter->header_left_logo)&&$surrender_letter->header_left_logo!='')
                                                @php $header_left_logo= 'storage/images/master_surrender_letters/'.$surrender_letter->header_left_logo; @endphp
                                            @endif
                                ...
                                <div class="form-group col-md-6 col-sm-12" style="min-height: 200px;float: right;">
                                    ...
                                    <label class="form-control-label up-image">
                                        <div class="container">
                                            ...
                                            @if(isset($surrender_letter->header_right_logo)&&$surrender_letter->header_right_logo!='')
                                                @php $header_right_logo= 'storage/images/master_surrender_letters/'.$surrender_letter->header_right_logo; @endphp
                                            @endif
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="sub_header_memo_first_part" id="sub_header_memo_first_part" value="{{$surrender_letter->sub_header_memo_first_part ?? ''}}">
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    <label class="form-control-label">স্মারক নং</label>
                                    <input type="text" class="form-control" name="sub_header_memo_second_part" id="sub_header_memo_second_part" value="{{$surrender_letter->sub_header_memo_second_part ?? ''}}" @if(!($surrender_letter->is_signed==1 && isset($surrender_letter->signature_date) && $surrender_letter->signature_date!=='')) disabled title="চিঠির উপরের অংশ সাক্ষরিত নয়" @endif >
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    <label class="form-control-label">স্মারকের তারিখ</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="sub_header_memo_date" name="sub_header_memo_date" readonly="readonly" placeholder="স্মারকের তারিখ লিখুন" value="{{$surrender_letter->sub_header_memo_date ?? ''}}"  >
...
{{--                                    <input type="text" class="form-control" name="sub_header_memo_first_part_2" id="sub_header_memo_first_part_2" value="{{$surrender_letter->sub_header_memo_first_part_2 ?? ''}}">--}}
{{--                                </div>--}}
{{--                                <div class="form-group col-md-4 col-sm-12">--}}
{{--                                    <label class="form-control-label">স্মারক নং (চিঠির নিচের অংশ)</label>--}}
{{--                                    <input type="text" class="form-control" name="sub_header_memo_second_part_2" id="sub_header_memo_second_part_2" value="{{$surrender_letter->sub_header_memo_second_part_2 ?? ''}}" @if(!($surrender_letter->is_signed_2==1 && isset($surrender_letter->signature_date_2) && $surrender_letter->signature_date_2!=='')) disabled title="চিঠির নিচের অংশ সাক্ষরিত নয়" @endif >--}}
{{--                                </div>--}}
{{--                                <div class="form-group col-md-4 col-sm-12">--}}
{{--                                    <label class="form-control-label">স্মারকের তারিখ (চিঠির নিচের অংশ)</label>--}}
{{--                                    <div class="input-group">--}}
{{--                                        <input type="text" class="form-control" id="sub_header_memo_date_2" name="sub_header_memo_date_2" readonly="readonly" placeholder="স্মারকের তারিখ লিখুন" value="{{$surrender_letter->sub_header_memo_date_2 ?? ''}}" @if(!($surrender_letter->is_signed_2==1 && isset($surrender_letter->signature_date_2) && $surrender_letter->signature_date_2!=='')) disabled title="চিঠির নিচের অংশ সাক্ষরিত নয়" @endif >--}}
{{--                                        <div class="input-group-append">--}}
{{--                                            <button class="btn btn-outline-dark btn-sm" style="height:29px;" type="button" onclick="clearThis('sub_header_memo_date_2')" @if(!($surrender_letter->is_signed_2==1 && isset($surrender_letter->signature_date_2) && $surrender_letter->signature_date_2!=='')) disabled title="চিঠির নিচের অংশ সাক্ষরিত নয়" @endif >Clear</button>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <textarea name="subject" id="subject" style="width: 100%;">{{$surrender_letter->subject ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label class="form-control-label">সূত্র</label>
                                    <textarea name="reference" id="reference" style="width: 100%;">{{$surrender_letter->reference ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label class="form-control-label">বর্ণনা</label>
                                    <textarea name="description" id="description" style="width: 100%;">{{$surrender_letter->description ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <textarea name="surrender_table" id="surrender_table" style="width: 100%;">{{$surrender_letter->surrender_table ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label class="form-control-label">নির্দেশনা</label>
                                    <textarea name="instructions" id="instructions" style="width: 100%;">{{$surrender_letter->instructions ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row" style="text-align: center !important;">
                                <div class="form-group col-md-12 col-sm-12" style="min-height: 200px;float: left;">
                                    ...
                                    <label class="form-control-label up-image">
                                        <div class="container">
                                            ...
                                            @if(isset($surrender_letter->signature_image)&&$surrender_letter->signature_image!='')
                                                @php $signature_image= 'storage/images/master_surrender_letters/'.$surrender_letter->signature_image; @endphp
                                            @endif
...
{{--                                            @if(isset($surrender_letter->signature_image_2)&&$surrender_letter->signature_image_2!='')--}}
{{--                                                @php $signature_image_2= 'storage/images/master_surrender_letters/'.$surrender_letter->signature_image_2; @endphp--}}
{{--                                            @endif--}}
...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control select2" name="is_signed" id="is_signed" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part!='' || $surrender_letter->sub_header_memo_date!='') disabled  title="পত্রটিতে স্মারকের উপরের অংশে স্মারক সম্পন্ন।"  @endif>
                                        <option value="0" @if($surrender_letter->is_signed==0) selected @endif >হয়নি</option>
                                        <option value="1" @if($surrender_letter->is_signed==1) selected @endif >হয়েছে</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <label class="form-control-label">সাক্ষরের তারিখ</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="signature_date" name="signature_date" readonly="readonly" placeholder="সাক্ষরের তারিখ লিখুন" value="{{$surrender_letter->signature_date ?? ''}}" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part!='' || $surrender_letter->sub_header_memo_date!='') disabled  title="পত্রটিতে স্মারকের উপরের অংশে স্মারক সম্পন্ন।"  @endif>
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-dark btn-sm" style="height:29px;" type="button" onclick="clearThis('signature_date')" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part!='' || $surrender_letter->sub_header_memo_date!='') disabled  title="পত্রটিতে স্মারকের উপরের অংশে স্মারক সম্পন্ন।"  @endif>Clear</button>
                                        </div>
                                    </div>
                                </div>
{{--                                <div class="form-group col-md-3 col-sm-6">--}}
{{--                                    <label class="form-control-label">চিঠি স্বাক্ষর (নিচের অংশে)</label>--}}
{{--                                    <select class="form-control select2" name="is_signed_2" id="is_signed_2" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part_2!='' || $surrender_letter->sub_header_memo_date_2!='') disabled  title="পত্রটিতে স্মারকের নিচের অংশে স্মারক সম্পন্ন।"  @endif>--}}
{{--                                        <option value="0" @if($surrender_letter->is_signed_2==0) selected @endif >হয়নি</option>--}}
{{--                                        <option value="1" @if($surrender_letter->is_signed_2==1) selected @endif >হয়েছে</option>--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                                <div class="form-group col-md-3 col-sm-6">--}}
{{--                                    <label class="form-control-label">সাক্ষরের তারিখ (নিচের অংশে)</label>--}}
{{--                                    <div class="input-group">--}}
{{--                                        <input type="text" class="form-control" id="signature_date_2" name="signature_date_2" readonly="readonly" placeholder="সাক্ষরের তারিখ লিখুন" value="{{$surrender_letter->signature_date_2 ?? ''}}" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part_2!='' || $surrender_letter->sub_header_memo_date_2!='') disabled  title="পত্রটিতে স্মারকের নিচের অংশে স্মারক সম্পন্ন।"  @endif>--}}
{{--                                        <div class="input-group-append">--}}
{{--                                            <button class="btn btn-outline-dark btn-sm" style="height:29px;" type="button" onclick="clearThis('signature_date_2')" @if(!auth()->user()->can('sign-surrender-letter')) disabled title="আপনার পত্রটি সাক্ষরের অনুমতি নেই।" @elseif($surrender_letter->sub_header_memo_second_part_2!='' || $surrender_letter->sub_header_memo_date_2!='') disabled  title="পত্রটিতে স্মারকের নিচের অংশে স্মারক সম্পন্ন।"  @endif>Clear</button>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <textarea name="signature_info_left" id="signature_info_left" style="width: 100%;">{{$surrender_letter->signature_info_left ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label class="form-control-label">স্বাক্ষর বিবরণি</label>
                                    <textarea name="signature_info" id="signature_info" style="width: 100%;">{{$surrender_letter->signature_info ?? ''}}</textarea>
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="form-group col-md-12 col-sm-12">--}}
{{--                                    <label class="form-control-label">স্বাক্ষর বিবরণি (নিচের অংশ)</label>--}}
{{--                                    <textarea name="signature_info_2" id="signature_info_2" style="width: 100%;">{{$surrender_letter->signature_info_2 ?? ''}}</textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
...
{{--                                    <div style="display:none;" id="letter_to_hidden_input"></div>--}}
                                    <div class="showing-box" id="letter_to_showing_box" style="display: none;">{!! $surrender_letter->letter_to ?? '' !!}</div>
                                    <textarea name="letter_to" id="letter_to" style="width: 100%;">{{$surrender_letter->letter_to ?? ''}}</textarea>
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="form-group col-md-12 col-sm-12">--}}
...
{{--                                    <div class="showing-box" id="letter_acknowledgement_showing_box">{!! $surrender_letter->letter_acknowledgement ?? '' !!}</div>--}}
{{--                                    <textarea name="letter_acknowledgement" id="letter_acknowledgement" style="width: 100%; display: none;">{{$surrender_letter->letter_acknowledgement ?? ''}}</textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        </div>
...
@section('uncommonInJs')
    <script>
        ...
        $(function (){
            function initSelectedSurrender(){
                let surrenderId;
                let surrenderInnerArr;
                @foreach($surrender_letter->letter_surrender_transactions as $transaction)
                surrenderId={{$transaction->surrender->id}};
                surrenderInnerArr={
                    "id":surrenderId,
                    "code_id":{{$transaction->surrender->code_id}},
                    "code":'{{$transaction->surrender->code->code}}',
                    "amount":bn_Numbers(taka_format({{$transaction->surrender->amount}}))
                };
                selectedSurrenderDetail.push(surrenderInnerArr);
                selectedSurrender.push(surrenderId);
                allowedLinkedOptions.push(surrenderId);
            ...
            initSelectedSurrender();
            $("#editUnitSurrenderLetterForm").validate({
...
{{--    </script>--}}
    ...
    <script>
        ...
        {{--    let letter_name;--}}
        {{--    @foreach($surrender_letter->letter_acknowledgement_recipients as $recipient)--}}
