            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('commons/content_header.Allotment Report')</h5>
...
@section('uncommonInJs')
    <script>
        ...
        function get_set_report(){
            ...
            let route = '{{route('report.get-allotment-report')}}';
            $.ajax({
                url: route,
                data: {
                ...
                success: function (response) {
                    if (response) {
                        ...
                        htm+='<h5 class="text-center" style="font-size:14px; font-weight: bold; line-height: 20px;">'+ response.fiscal_year_filter_str +' অর্থসালে '+response.date_filter_str+' '+response.unit_id_filter_str+' ইউনিটে '+response.code_id_filter_str+' কোডে বরাদ্দ</h5>';
                        htm+='<table class="table table-bordered">';
                        htm+='<thead>';
                        htm+='<tr>';
                            htm+='<th class="text-center" style="vertical-align: middle;">ক্রমিক</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">অর্থবছর</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">ইউনিটের নাম</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">কোড</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">স্মারক</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">স্মারকের তারিখ</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">চাহিদা</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">বরাদ্দ</th>';
                            htm+='<th class="text-center" style="vertical-align: middle;">কোডভিত্তিক সর্বমোট</th>';
                        ...
                        for(let i=0; i<unit_rows.length; i++){
                            ...
                            htm+='<td class="text-center" style="min-width: 150px;">'+unit_rows[i].unit_name+'</td>';
                            htm+='<td class="text-center" style="min-width: 200px;">'+unit_rows[i].code+'</td>';
