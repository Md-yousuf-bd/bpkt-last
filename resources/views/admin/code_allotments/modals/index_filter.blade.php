        ...
        <div class="modal-content">
            <form>
                <div class="modal-header">
                    <h5 class="modal-title" id="filterLabel">কোডে বরাদ্দ খুঁজুন</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control select2" id="date_type_filter" style="width:100%;">
                                            ...
                                            <option value="allotment_memo_date" @if(isset($filter_selected_data) && isset($filter_selected_data['date_type_filter']) && $filter_selected_data['date_type_filter']=="allotment_memo_date") selected @endif >চাহিদার স্মারকের তারিখ</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
