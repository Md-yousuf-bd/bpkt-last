            ...
            <div class="col-lg-10 col-md-10 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('commons/content_header.Edit Master Allotment Letter')</h5>
                        <div class="card-tools">

                        </div>
                    </div>
                    <form id="editMasterAllotmentLetterForm" action="{{route('master-allotment-letter.update')}}" method="post" class="" enctype="multipart/form-data">
                        <div class="card-body">
                            {{ csrf_field() }}
...
{{--                            <div class="row">--}}
{{--                                <div class="form-group col-md-12 col-sm-12">--}}
{{--                                    <label class="form-control-label">বিতরণ</label>--}}
{{--                                    <textarea name="letter_to" id="letter_to" style="width: 100%;">{{$master_allotment_letter->letter_to ?? ''}}</textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="row">--}}
{{--                                <div class="form-group col-md-12 col-sm-12">--}}
{{--                                    <label class="form-control-label">জ্ঞাতার্থে</label>--}}
{{--                                    <textarea name="letter_acknowledgement" id="letter_acknowledgement" style="width: 100%;">{{$master_allotment_letter->letter_acknowledgement ?? ''}}</textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        </div>
                        <div class="card-footer">
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <button type="reset" class="btn btn-sm btn-default" onclick="resetForm('editMasterAllotmentLetterForm','ইউনিটের বরাদ্দ চিঠি পরিবর্তন ফরম','আপনি কি সত্যি ফরমটি রিসেট করতে চান?');return false;">@lang('commons/buttons.Reset')</button>
                                </div>
                            </div>
                        </div>
                    </form>
